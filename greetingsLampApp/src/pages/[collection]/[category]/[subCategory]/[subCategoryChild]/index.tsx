...
export const getServerSideProps = async (ctx) => {
    ...
    const subCategoryChild= subCategory ? subCategory.childrenSubCategory.filter(subChild=>subChild.slug===ctx.params.subCategoryChild)[0]:null
